    ...
    <React.Fragment>
      <div>
        <div className="bg-background">
          <div className="container relative mx-auto flex flex-col pt-5 px-4 sm:px-0">
      ...
      <div className="sticky -top-1 z-10 mx-auto border-b-4 border-background">
        <div className="bg-muted pt-3 pb-3">
          <InputGroup

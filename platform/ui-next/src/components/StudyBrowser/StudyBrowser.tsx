...
const StudyBrowser = ({
  ...
  return (
    <ScrollArea>
      <div
        className="bg-card text-card-foreground flex flex-1 flex-col gap-[4px]"
        data-cy={'studyBrowser-panel'}
      >
        <div className="flex flex-col gap-[4px]">
          {showSettings && (
            <div className="bg-muted flex h-[48px] w-100 items-center justify-center gap-[10px] px-[8px] py-[10px]">
              <>

...
function CustomizableViewportOverlay({
  ...
  const bottomLeftActionCustomization = customizationService.getCustomization(
  ...
  return (
    <ViewportOverlay
      ...
      bottomLeftAction={getContent(bottomLeftActionCustomization, 'bottomLeftActionOverlayItem')}
